...
public class Adotante {
	...
	public Adotante(int id, String nome, String telefoneFixo, String telefoneCelular, String email, Endereco endereco,
			boolean impedimento, String motivoImpedimento) {
		super();
		this.id = id;
		this.nome = nome;
